...
- Investigation on different environments 
...
techniques Slack-Git.  Git-Magit file sharing
...
To insert and image do the following:
...
Export as LaTeX and then process and open PDF file.
...
You can =commit= files by clicking =c c= 
Write a cooment and =commit= with =C-c C-c=
