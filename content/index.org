...
LFNoise1.ar(pan).range(-1, 1), envbuf)*env;		source = LPF.ar(source, freq2);
...
SynthDef(\klank01, {|out = 0, gate = 1, vol = 0.0001, freq = 
440, freq3 = 999, freq2 = 444  decay = 0.02, cutoff = 2000, amp = 0.01, trig = 1,
