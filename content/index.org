...
#+BEGIN_EXAMPLE
#+Caption: Wiring MPR121 c_s to Raspberry pi
#+Name: fig 01
[[./images/wiringMPR121Raspberry]]
#+END_EXAMPLE
...
list buffer.
In the notebook list buffer, you can navigate to your folders to [open], [create], and [delete] notebooks
...
and the key for the corresponding IP address fe80::6438:a684:af09:7907%en1
has a different value. This could either mean that
DNS SPOOFING is happening or the IP address for the host
and its host key have changed at the same time.
Offending key for IP in /Users/vasilis/.ssh/known_hosts:7
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
SHA256:2klTIS/Gsubfxiwj9xHnml5H82W77+m9rN8pPJ1pbfU.
Please contact your system administrator.
Add correct host key in /Users/vasilis/.ssh/known_hosts to get rid of this message.
Offending ECDSA key in /Users/vasilis/.ssh/known_hosts:19
ECDSA host key for raspberrypi.local has changed and you have requested strict checking.
Host key verification failed.
#+End_Example

Go and delete previous keys in =known_hosts= file like pi@raspnberrypi.local

then try again to ssh pi@raspnberrypi.local
...
then you can start adding packages like supercollider, jack and others.
...
#+END_SRC
run supercollider through emacs
...
* Open raspberrypi3 from your emacs using TRAMP
...
dired to your file, make changes and save!!!
...
#+BEGIN_SRC shell
voices git:(SuperCollider) ✗ rsync -avz -e ssh pi@192.168.1.96:~/001WorkFiles/voices/ voices/
...
#+BEGIN_SRC shell
$ rsync -avP sounds/ pi@192.168.1.96:~/001WorkFiles/voices/sounds
#+END_SRC
...
#+BEGIN_SRC shell
$ ffmpeg -i /Users/vasilis/Documents/001Workfiles/Weaving-voices/sounds/23.3.\ j.m4a  23.3.\ j.wav
#+END_SRC
