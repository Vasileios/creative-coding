...
Choose the *Python* mode on the right panel of the screen to see the code.
...
#+BEGIN_QUOTE
choose Shell as the language to see the code
#+END_QUOTE
...
#+BEGIN_QUOTE
choose 'emacs-lisp' as the language to see the code
#+END_QUOTE
#+BEGIN_SRC lisp
(require 'ein)
#+END_SRC
