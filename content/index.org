...
#+CAPTION: Beat Frequency example - wobbles (μετατοπίσεις)
#+NAME: Fig.1:BF - 440-443Hz
[[/Users/vasilis/Documents/Projects/sites/pics/images/BeatFrequency_snapshot.png]]


#+CAPTION: Beat Frequency example - Total Wave after a summation of two waves
#+NAME: Fig.2:Total wave
[[/Users/vasilis/Documents/Projects/sites/pics/images/TotalWave_BeatF.png]]
...
[[~/Documents/org-mode/org-mode_webpage/img/Odysseus.png][Image]]
...
#+BEGIN_SRC ditta :file images/table01.png
...
#+RESULTS:
: /Users/vasilis/.emacs.d/elpa/contrib/scripts/ditaa.jar




** Dot-Graphviz (Graph visualisation software)
...
** Insert 3 asterisks and type TODO to create a todo object
...
** Work
** TODO read about live coding software
SCHEDULED: <2016-11-10 Thu>


** DONE export html minted [fn:1] (highlight colour - syntax source blocks)
SCHEDULED: <2016-10-12 Wed
** htmlize.el via MELPA is installed
(setq org-src-fontify-natively t) has been inserted in init.el
** minted, babel, auto-complete, latex
...
** TODO syntax highlight code blocks for latex-pdf

** TODO image and video appearances when export to html and pdf
SCHEDULED: <2016-10-12 Wed>
Find how to display images and videos when export to html and pdf file


[fn:1] Find more here: [[http://orgmode.org/worg/org-tutorials/org-latex-preview.html][Minted]]
...
vasiliss-mbp:Epiplus_WordPress vasilis$ git pull origin
You asked to pull from the remote 'origin', but did not specify
a branch. Because this is not the default configured remote
for your current branch, you must specify a branch on the command line.
vasiliss-mbp:Epiplus_WordPress vasilis$ git pull origin WordPress-package
fatal: Couldn't find remote ref WordPress-package
vasiliss-mbp:Epiplus_WordPress vasilis$ fatal: The remote end hung up unexpectedly
git pull origin WordPress-init
From bitbucket.org:wordpressepiplus/wordpress_epiplus
 * branch            WordPress-init -> FETCH_HEAD
Updating b02b67d..2e2138c
Fast-forward
 README.md | 29 +++++++++++++++++++++++++++++
 1 file changed, 29 insertions(+)
 create mode 100644 README.md
vasiliss-mbp:Epiplus_WordPress vasilis$
...
#+CAPTION: A snapshot for Pdf export references /bibtex/, /org-mode/
     #+NAME:   fig:Pdf export references
     [[./images/sample_refs_pdf_bibtex.png]]
