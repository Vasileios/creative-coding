...
intersemiotic translation, post-disciplinarity (interdisciplinarity, multidiscplinary) and the general concerns of Human Computer Interaction (HCI). 

#+BEGIN_QUOTE
*Key words:* big-data, connectivity, data, creative-coding, emacs, interaction, interdisciplinary, interactive design, interconnectio, machine learning, multidisciplinary, org-mode, real-time, streaming, web 
#+END_QUOTE
...
This blog contains some basic information and tips (installations and usage) about emacs, SuperCollider, Raspberry pi.
