...
I have developed some algorithmic approaches so as to map text to
...
chapter. I have mapped the text to numeric values. These values could then be easily used to deter mine the parameters of the sound such as, frequency, amplitude, timbre and rhythm.
