...
visual and audio fragmenta- tion, generative systems, chaos and
complexity as well as other conceptual influences. For instance, in my
following works I have been inspired by the Jungian approach to
symbolic interpretation. I have interrelated the symbolism of Nekyia
...
journalistic inter- views in the book C.G Jung Speaking (1987) in the
case of the modern artist). In Aranea I translat- ed an archetypical
story of pride into a video game; expressing psychological complexes,
like the Icarus' complex or narcissism, in relation to the concept of
hubris and nemesis as they are found in the story of Arachne. 
...
In this piece I also developed some algorithmic approaches to map text to sound, using the SuperCollider language. I have used the same method of collecting characters as I have done with L-systems in chapter 2. In particular, I experimented with the idea of using the letters of Homer's Nekyia text and mapping them to numeric values. These values could then be easily used to deter- mine the parameters of the sound such as, frequency, amplitude, timbre and rhythm.
...
resulting algorithm it is possible to use a large quantity of val- ues
...
Greek I have used its scansion system. The Dactyl ( -uu ) is a metrical pattern known as a "foot" which comprises one long syllable followed by two short syllables. 
